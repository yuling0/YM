...
namespace Sirenix.OdinInspector.Demos.RPGEditor
{
    ...
    public class RPGEditorWindow : OdinMenuEditorWindow
    {
        ...
        protected override OdinMenuTree BuildMenuTree()
        {
            ...
            tree.DefaultMenuStyle.IconSize = 28.00f;        //设置菜单图标大小
            tree.Config.DrawSearchToolbar = true;           //是否绘制搜索栏

            // Adds the character overview table.
            CharacterOverview.Instance.UpdateCharacterOverview();       //更新检索的Character
