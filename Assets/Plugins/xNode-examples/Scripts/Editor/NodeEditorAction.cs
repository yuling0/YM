        ...
        public void Controls() {
            ...
            switch (e.type) {
                    ...
                    if (e.button == 0) {
                        ...
                        if (IsDraggingPort) {
                            ...
                            // Open context menu for auto-connection if there is no target node
                                ...
                                var nodePos = NodeEditorWindow.current.WindowToGridPosition(mousePos);
                                graphEditor.AddContextMenuItems(null, nodePos).ShowInPopup(mousePos);
                            }
                ...
                case EventType.KeyDown:
                    ...
                    {
                        var mousePos = Event.current.mousePosition;
                        var pos = NodeEditorWindow.current.WindowToGridPosition(mousePos);

                        graphEditor.AddContextMenuItems(null, pos).ShowInPopup(mousePos);
                    }
                    break;
