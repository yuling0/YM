...
namespace XNodeEditor {
    ...
    public class NodeEditor : XNodeEditor.Internal.NodeEditorBase<NodeEditor, NodeEditor.CustomNodeEditorAttribute, XNode.Node> {
        ...
        {
            if (NodeEditorUtilities.GetAttrib(target.GetType(), out XNode.Node.NodeTitleAttribute labelText))
            {
                title = $"{target.name}({labelText.title})";
                allowCustomName = labelText.allowCustomName;
            }
        }
