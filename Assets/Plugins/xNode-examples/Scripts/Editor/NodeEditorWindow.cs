...
namespace XNodeEditor {
    ...
    public partial class NodeEditorWindow : EditorWindow {
        ...
        private static void OnLoad() {
            Selection.selectionChanged -= OnSelectionChanged;   //切换选择对象时的回调
        ...
        public static bool OnOpen(int instanceID, int line) {
            XNode.NodeGraph nodeGraph = EditorUtility.InstanceIDToObject(instanceID) as XNode.NodeGraph;//确认打开的是否为NodeGraph
            if (nodeGraph != null) {
                Open(nodeGraph);
                return true;
            }
