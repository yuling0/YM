...
namespace NPBehave
{
    public class Blackboard
    {
        ...
        private Dictionary<string, List<System.Action<Type, object>>> observers = new Dictionary<string, List<System.Action<Type, object>>>();      //对应数据的观察者
        private bool isNotifiyng = false;
        private Dictionary<string, List<System.Action<Type, object>>> addObservers = new Dictionary<string, List<System.Action<Type, object>>>();       //添加缓冲
        private Dictionary<string, List<System.Action<Type, object>>> removeObservers = new Dictionary<string, List<System.Action<Type, object>>>();    //移除缓冲

        private List<Notification> notifications = new List<Notification>();        //通知
